...
"""Verify that starting theholyroger with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start theholyroger with -h for help text")
        ...
        self.log.info("Start theholyroger with -version for version information")
