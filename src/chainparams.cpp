...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000001d620ca7a731f71");
        ...
        checkpointData = {
            {
                ...
                {  453000, uint256S("0xafc042fe763d1a8eca496bb0db36a824385919a275d1141e136845044d7ee7ca")},
            }
        };
