...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9662
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9663
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19662
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19665
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 9662
	%{_sbindir}/semanage port -d -p tcp 9663
	%{_sbindir}/semanage port -d -p tcp 19662
	%{_sbindir}/semanage port -d -p tcp 19665
