...
VERSION=
commit=false
url=https://github.com/TheHolyRogerCoin/TheHolyRogerCoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/TheHolyRogerCoin/TheHolyRogerCoin
...
then
    ...
    git clone https://github.com/TheHolyRogerCoin/theholyroger-detached-sigs.git
...
then
	# Make output folder
	mkdir -p ./theholyroger-binaries/${VERSION}
