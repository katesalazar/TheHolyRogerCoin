...
* Update manpages, see [gen-manpages.sh](https://github.com/TheHolyRogerCoin/TheHolyRogerCoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/TheHolyRogerCoin/gitian.sigs.theholyroger.git
    git clone https://github.com/TheHolyRogerCoin/theholyroger-detached-sigs
...
- Detached signatures will then be committed to the [theholyroger-detached-sigs](https://github.com/TheHolyRogerCoin/theholyroger-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Update title of #TheHolyRoger and #theholyroger-dev on Libera IRC

  - Optionally twitter, reddit /r/TheHolyRoger, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/TheHolyRogerCoin/TheHolyRogerCoin/releases/new) with a link to the archived release notes.
